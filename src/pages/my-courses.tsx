...
import { Book, CheckCircle, BookX, AlertCircle } from 'lucide-react';
            ...
            <div>
              ...
              {teacher && (
                <div className="flex items-center mt-2 gap-2">
                  <img
                    src={teacher.profile?.avatar || `https://ui-avatars.com/api/?name=${teacher.firstName}+${teacher.lastName}&background=random`}
  ...
  const fetchMyCourses = async () => {
    ...
    try {
      ...
      const mockCourses: (Course & { progress: number })[] = [
        { id: 1, title: 'Математическая грамотность', description: '', subject: 'Математика', price: '15000', teacher: { id: 1, firstName: 'Айжан', lastName: 'Берикова', email: '', role: 'teacher', isActive: true, profile: { id: 1, avatar: '' } }, progress: 75 },
        { id: 2, title: 'История Казахстана', description: '', subject: 'История', price: '15000', teacher: { id: 2, firstName: 'Тимур', lastName: 'Сапаров', email: '', role: 'teacher', isActive: true, profile: { id: 2, avatar: '' } }, progress: 100 },
        { id: 3, title: 'Физика для ЕНТ', description: '', subject: 'Физика', price: '18000', teacher: { id: 3, firstName: 'Ермек', lastName: 'Жангиров', email: '', role: 'teacher', isActive: true, profile: { id: 3, avatar: '' } }, progress: 30 },
      ];
